# Menyiapkan basis data yang akan digunakan
1. Buat sebuah database baru di MySQL dengan nama `warehouse`.
2. Buat tabel baru dengan nama `products`.
    ```sql
...
3. Buat tabel baru dengan nama `categories`.
    ```sql
